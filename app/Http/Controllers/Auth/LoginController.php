...
class LoginController extends Controller
{
    ...
    */
     ...
     */
    public function showParentsLoginForm()
    {
        return view('auth.login', [
            'url' => Config::get('constants.guards.parents')
        ]);
    }
    ...
    {   
        ...
        if ($this->guardLogin($request, Config::get('constants.guards.default'))) {//dd("her");
    ...
    {
        if ($this->guardLogin($request, Config::get('constants.guards.parents'))) {
            return redirect()->intended('/parents');
        }
